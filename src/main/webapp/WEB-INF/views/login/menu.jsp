			...
			success:function(data) {
				...
				if(data!=null && data!="") {
					...
					$.each(data, function(i){
						 submenu += "<li><a href='groupMainPage.do?group_code="+data[i].group_code+"' class='submenuLink longLink'>"+data[i].group_name+"</a></li>";
					});
		...
		success:function(data) {
			...
			if(data!=null && data!="") {
				...
				$.each(data, function(i){
					...
					submenu += "<li><a href='goSubMenu.do' class='submenuLink longLink'>"+data[i].group_name+"</a></li>"
								+"<li><a href='goSubMenu.do' class='submenuLink longLink'>"+data[i].group_code+"</a></li>"
								+"<li><a href='goSubMenu.do' class='submenuLink longLink'>"+data[i].group_info+"</a></li>";
